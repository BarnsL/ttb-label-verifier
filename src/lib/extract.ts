 ...
 * changes. Default is the most capable vision model; for the TTB 5-second SLA,
 * set ANTHROPIC_MODEL=claude-haiku-4-5 (fastest) or claude-sonnet-4-6 (balanced).
 */
...
/** Send a label image to Claude vision and return structured fields. */
